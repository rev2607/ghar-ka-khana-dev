...
const HeroSection = () => {
  return (
    <section className="w-full pt-8 md:pt-16 pb-8 bg-gradient-to-b from-[#FFD9A0] to-white overflow-hidden">
      {/* Mobile layout: Offer box at top, food image below */}
      <div className="block md:hidden w-full px-4 pt-8 pb-4 bg-gradient-to-b from-[#FFD9A0] to-white">
        {/* Offer Box */}
        <div className="flex flex-col items-center justify-center text-center z-10 px-8 py-6 rounded-2xl border border-orange-300 shadow-xl backdrop-blur-md bg-white/60 mx-auto mb-4" style={{ minWidth: '8rem', minHeight: '8rem' }}>
          ...
          <div className="flex flex-row items-end gap-2 justify-center mb-1 whitespace-nowrap">
            <span className="text-[#723303] text-lg font-bold">Price =</span>
            <span className="text-[#e11d48] text-3xl font-extrabold">69/-</span>
          </div>
          <div className="text-[#723303] text-base font-medium bg-orange-100 rounded-full px-3 py-1 mt-1">(Per Meal)</div>
        </div>
        {/* Food Image */}
        <div className="w-full flex justify-center mb-4">
          <img src="/food.png" alt="Food Tray" className="w-64 max-w-[90vw] h-auto object-contain rounded-xl shadow" />
        </div>
      </div>
